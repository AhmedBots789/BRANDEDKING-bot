...
async def init():
    ...
    await BRANDED.start()
    try:
        await BRANDED.stream_call("https://telegra.ph//file/86284cf8469c6f011c426.jpg")
    ...
    LOGGER("BRANDEDKING").info(
        "Sanji X Music Bot Started Successfully"
    )
    await idle()
    await app.stop()
    LOGGER("BRANDEDKING").info("Stopping Sanji X Music Bot...")
